...
public class screen2 extends JPanel {
	 ...
	 * public void actionPerformed(ActionEvent arg0) {
	 * //System.out.println(membersCount + " " + flag);
	 * this.frame.setVisible(false); String s =
	 * comboBox.getSelectedItem().toString(); int x = Integer.parseInt(s);
	 * boolean flag = checkbox.isSelected(); screen2 obj = new screen2(x,flag);
	 * obj.createAndShowGUI();
	 * 
	 * }
	 */
...
>>>>>>> d02dc93899dfc5aa275b83bba5ba19e218d15c63
