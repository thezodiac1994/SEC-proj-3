 ...
 */
public class CreateList2 extends JFrame implements ListSelectionListener, ActionListener {
  ...
  public CreateList2() {
    ...
    myList = new JList();
    ListModel model = new ListModel9b();
  ...
  public static void main(String[] args) {
    CreateList2 window = new CreateList2();
  ...
  public void actionPerformed(ActionEvent arg0) {
    ...
    if (value != null) {
      ((ListModel9b)myList.getModel()).addData(value);
    } else {
      ((ListModel9b)myList.getModel()).removeData(0);
    }      
  }
