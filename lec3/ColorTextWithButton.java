 ...
 */
public class ColorTextWithButton extends JFrame implements ActionListener {
  ...
  public static void main(String[] args) {
    ColorTextWithButton example = new ColorTextWithButton();
